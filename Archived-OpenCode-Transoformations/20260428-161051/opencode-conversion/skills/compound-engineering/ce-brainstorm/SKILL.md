...
Brainstorming helps answer **WHAT** to build through collaborative dialogue. It precedes `skill({ name: "ce-plan" })`, which answers **HOW** to build it.
...
- **Tools available + user asked**: Dispatch @compound-engineering/ce-slack-researcher with a brief summary of the brainstorm topic alongside Phase 1.1 work. Incorporate findings into constraint and context awareness.
